...
export INITRAMFS_SOURCE=`readlink -f ..`/elite_kernel_jf/Ramdisks/AOSP_ATT
...
make VARIANT_DEFCONFIG=jf_att_defconfig SELINUX_DEFCONFIG=jfselinux_defconfig SELINUX_LOG_DEFCONFIG=jfselinux_log_defconfig elite_kernel_defconfig
...
cp Packages/01kernel $PACKAGEDIR/system/etc/init.d/01kernel
cp Packages/02sysctl $PACKAGEDIR/system/etc/init.d/02sysctl
cp Packages/04elite_tweaks $PACKAGEDIR/system/etc/init.d/04elite_tweaks
cp Packages/05elitefs $PACKAGEDIR/system/etc/init.d/05elitefs
cp Packages/80loopysmoothnesstweak $PACKAGEDIR/system/etc/init.d/80loopysmoothnesstweak
cp Packages/91zipalign $PACKAGEDIR/system/etc/init.d/91zipalign
cp Packages/97tcp $PACKAGEDIR/system/etc/init.d/97tcp
cp Packages/98tweaks $PACKAGEDIR/system/etc/init.d/98tweaks
cp Packages/99system $PACKAGEDIR/system/etc/init.d/99system
