...
#define MCI_IRQENABLE_SDC3 \
	(MCI_DATACRCFAILMASK|MCI_DATATIMEOUTMASK|MCI_TXUNDERRUNMASK|	\
	MCI_RXOVERRUNMASK|MCI_DATAENDMASK|MCI_PROGDONEMASK| \
	MCI_AUTOCMD19TIMEOUTMASK)
#endif
#define MCI_IRQ_PIO 	\
